/mob/living/carbon/human/proc/ambient_xeno_message(var/mob/living/carbon/human/thisxeno, var/msg = "lowplasma")
	switch (msg)
		if ("noplasma")
			boutput(thisxeno, "<span style=\"color:red\><B><font size = 3>Your plasma reserves have been entirely depleted.</span></B></font>")
		if ("lowplasma")
			boutput(thisxeno, "<span style=\"color:red\><B>Your plasma reserves are almost depleted.</span></B>")
		if ("medplasma")
			boutput(thisxeno, "<span style=\"color:red\><B>You have used up a great deal of your plasma reserves.</span></B>")
		if ("highplasma")
			boutput(thisxeno, "<span style=\"color:green\><B>Your plasma reserves are almost fully filled.</span></B>")
		if ("maxplasma")
			boutput(thisxeno, "<span style=\"color:green\><B>Your plasma reserves have fully recovered.</span></B>")

		if ("nohealth")
			boutput(thisxeno, "<span style=\"color:red\><B><font size = 3>You are in critical condition. Death may be imminent.</span></B></font>")
		if ("lowhealth")
			boutput(thisxeno, "<span style=\"color:red\><B>Your health is low.</span></B>")
		if ("medhealth")
			boutput(thisxeno, "<span style=\"color:red\><B>You have lost some health.</span></B>")
		if ("highhealth")
			boutput(thisxeno, "<span style=\"color:red\><B>Your health has almost fully recoverd.</span></B>")
		if ("maxhealth")
			boutput(thisxeno, "<span style=\"color:green\><B>You have fully healed.</span></B>")

		if ("nofire")
			boutput(thisxeno, "<span style=\"color:green\><B>Your skin feels a normal temperature again.</span></B>")
		if ("lowfire")
			boutput(thisxeno, "<span style=\"color:red\><B>Your skin feels just slightly hot.</span></B>")
		if ("medfire")
			boutput(thisxeno, "<span style=\"color:red\><B>Your skin tingles. It is a bit hot, but not yet dangerous.</span></B>")
		if ("highfire")
			boutput(thisxeno, "<span style=\"color:red\><B>Your skin sears with pain; It is too hot.</span></B>")
		if ("maxfire")
			boutput(thisxeno, "<span style=\"color:red\><B><font size = 3>Your skin sears with extreme pain! It is far too hot.</span></B></font>")

		if ("nostamina")
			boutput(thisxeno, "<span style=\"color:red\><B><font size = 3>Your stamina is fully depleted. You are in danger.</span></B></font>")
		if ("lowstamina")
			boutput(thisxeno, "<span style=\"color:red\><B>Your stamina is low.</span></B>")
		if ("medstamina")
			boutput(thisxeno, "<span style=\"color:red\><B>You have lost some stamina.</span></B>")
		if ("highstamina")
			boutput(thisxeno, "<span style=\"color:red\><B>Your stamina has almost fully recoverd.</span></B>")
		if ("maxstamina")
			boutput(thisxeno, "<span style=\"color:green\><B>Your stamina has fully recovered.</span></B>")

		if ("almostevotime")
			boutput(thisxeno, "<span style=\"color:green\><B>You are almost ready to evolve.</span></B>")
		if ("evotime")
			boutput(thisxeno, "<span style=\"color:green\><B><font size = 3>You are ready to evolve.</span></B></font>")

		else
			boutput(thisxeno, msg)//msgs will need their own span styles and boldshit in this case
...
/mob/living/carbon/human/take_eye_damage(var/amount, var/tempblind = 0, var/side)
	if (!src || !ishuman(src) || (!isnum(amount) || isAlien(src) || amount == 0))
		return 0
...
/mob/living/carbon/human/get_eye_damage(var/tempblind = 0, var/side)
	if (isAlien(src))//aliens don't even have eyes
		return 0
	if (tempblind == 0)
		var/eye_dam = 0
		if (src.organHolder)
