/mob/living/carbon/human/proc/ambient_xeno_message(var/mob/living/carbon/human/thisxeno, var/msg = "lowplasma")
	switch (msg)
		if ("noplasma")
			boutput(thisxeno, "<span class='game xenobold'><font size = 3>Your plasma reserves have been entirely depleted.</span></font>")
		if ("lowplasma")
			boutput(thisxeno, "<span class='game xenobold'>Your plasma reserves are almost depleted.</span>")
		if ("medplasma")
			boutput(thisxeno, "<span class='game xenobold'>You have used up a great deal of your plasma reserves.</span>")
		if ("highplasma")
			boutput(thisxeno, "<span class='game xenobold'>Your plasma reserves are almost fully filled.</span>")
		if ("maxplasma")
			boutput(thisxeno, "<span class='game xenobold'>Your plasma reserves have fully recovered.</span>")

		if ("nohealth")
			boutput(thisxeno, "<span class='game xenobold'><font size = 3>You are in critical condition. Death may be imminent.</span></font>")
		if ("lowhealth")
			boutput(thisxeno, "<span class='game xenobold'>Your health is low.</span>")
		if ("medhealth")
			boutput(thisxeno, "<span class='game xenobold'>You have lost some health.</span>")
		if ("highhealth")
			boutput(thisxeno, "<span class='game xenobold'>Your health has almost fully recoverd.</span>")
		if ("maxhealth")
			boutput(thisxeno, "<span class='game xenobold'>You have fully healed.</span>")

		if ("nofire")
			boutput(thisxeno, "<span class='game xenobold'>Your skin feels a normal temperature again.</span>")
		if ("lowfire")
			boutput(thisxeno, "<span class='game xenobold'>Your skin feels just slightly hot.</span>")
		if ("medfire")
			boutput(thisxeno, "<span class='game xenobold'>Your skin tingles. It is a bit hot, but not yet dangerous.</span>")
		if ("highfire")
			boutput(thisxeno, "<span class='game xenobold'>Your skin sears with pain; It is too hot.</span>")
		if ("maxfire")
			boutput(thisxeno, "<span class='game xenobold'><font size = 3>Your skin sears with extreme pain! It is far too hot.</span></font>")

		if ("nostamina")
			boutput(thisxeno, "<span class='game xenobold'><font size = 3>Your stamina is fully depleted. You are in danger.</span></font>")
		if ("lowstamina")
			boutput(thisxeno, "<span class='game xenobold'>Your stamina is low.</span>")
		if ("medstamina")
			boutput(thisxeno, "<span class='game xenobold'>You have lost some stamina.</span>")
		if ("highstamina")
			boutput(thisxeno, "<span class='game xenobold'>Your stamina has almost fully recoverd.</span>")
		if ("maxstamina")
			boutput(thisxeno, "<span class='game xenobold'>Your stamina has fully recovered.</span>")

		if ("almostevotime")
			boutput(thisxeno, "<span class='game xenobold'>You are almost ready to evolve.</span>")
		if ("evotime")
			boutput(thisxeno, "<span class='game xenobold'><font size = 3>You are ready to evolve.</span></font>")
