...
/turf/simulated/wall/attack_hand(mob/user as mob)
	if (user.bioHolder.HasEffect("xeno"))
		if (ishuman(user))
					...
					if (istype(grave) && !grave.robbed)
						...
						if (grave.special)
							...
							switch (rand(1,5))
								...
								if (2)
									new /obj/item/woodstuff/plank {name = "rotted coffin wood"; desc = "Just your normal, everyday rotten wood.  That was robbed.  From a grave.";} ( src )
								if (3)
