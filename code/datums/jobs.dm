...
//this will spawn them with no ID, assistant clothing, and random items.
...
// Xeno survivors: Have 7 builds FTTB, 3 of which are traitor only.
/*
/datum/job/civilian/survivor//rn just staff assistant clone
	name = "Survivor"
	limit = 100
	wages = 50
	...
	New()
		...
		var/whatbuild = rand(1, 7)

		switch (whatbuild)
			if (1)
				slot_belt = /obj/item/tank/emergency_oxygen
				items_in_backpack = list(/obj/item/gun/energy/phaser_gun)
				slot_poc1 = /obj/item/device/flash
				slot_poc2 = /obj/item/wrench
				if (prob(60))
					items_in_backpack -= typesof(/obj/item/gun/energy)
			if (2)
				slot_belt = /obj/item/tank/emergency_oxygen
				items_in_backpack = list(/obj/item/gun/energy/egun)
				slot_poc1 = /obj/item/device/flash
				slot_poc2 = /obj/item/wrench
				if (prob(60))
					items_in_backpack -= typesof(/obj/item/gun/energy)
			if (3)
				slot_belt = /obj/item/tank/emergency_oxygen
				items_in_backpack = list(/obj/item/gun/energy/laser_gun)
				slot_poc1 = /obj/item/device/flash
				slot_poc2 = /obj/item/wrench
				if (prob(60))
					items_in_backpack -= typesof(/obj/item/gun/energy)
			if (4)
				slot_belt = /obj/item/weldingtool
			...
			if (5)
				...
				items_in_backpack = list(/obj/item/gun/energy/egun)
				slot_poc1 = /obj/item/device/flash
				slot_poc2 = /obj/item/screwdriver
				if (prob(60))
					items_in_backpack -= typesof(/obj/item/gun/energy)
			if (6)
				slot_belt = /obj/item/tank/emergency_oxygen
				items_in_backpack = list(/obj/item/gun/energy/laser_gun)
				slot_poc1 = /obj/item/device/flash
				slot_poc2 = /obj/item/wirecutters
				if (prob(60))
					items_in_backpack -= typesof(/obj/item/gun/energy)
			if (7)
				slot_belt = /obj/item/tank/emergency_oxygen
