...
(t)fri oct 1 16
(u)Cherkir
(*)Various bug fixes, buggy build of the hunger systems, made weeds decay human and robot parts after 60 to 90 seconds.
(t)fri sep 30 16
(u)Cherkir
(*)Added various bug fixes, worked on crafting a bit more, and made expediated Xeno evolution system.
(t)thu feb 18 15
(u)SpyGuy
