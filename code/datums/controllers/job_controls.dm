...
/datum/job_controller/
	...
	//	src.staple_jobs = list(new /datum/job/civilian/survivor ())
		...
		if (derelict_mode)
			...
			if (ALIENMODE)
				for (var/datum/job/J in src.staple_jobs)
					if (istype(J, /datum/job/civilian/AI) || istype(J, /datum/job/civilian/cyborg) || istype(J, /datum/job/civilian/clown) || istype(J, /datum/job/special))
						staple_jobs -= J
