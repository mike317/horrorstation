...
//this was moved from /datum/chemistry/tools, even though food is chem related it was
//a stupid place to put this since this defines everything that has to do with other food
//procs
...
//	var/hunger_heal = 10
	...
	New()
		...
		if (istype(src, /obj/item/reagent_containers/food/snacks/ingredient/meat) || istype(src, /obj/item/reagent_containers/food/snacks/plant))
			if (prob(1))
