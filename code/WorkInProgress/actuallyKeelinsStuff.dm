...
/obj/item/craftedmelee/ghettotool
	name = "If you see this name, Cherkir is an absolute moron"
	var/sharpened = NOT_SHARP
	var/heat = NOT_HOT
...
/obj/item/craftedmelee/ghettotool/crowbar
	...
	electrobar
		...
		icon = 'icons/adolf12/electric bar.dmi'
		icon_state = "off"
...
/obj/item/craftedmelee/ghettotool/wirecutters
	...
	electrocutters
		...
		icon = 'icons/adolf12/electric cutters.dmi'
		icon_state = "off"
...
/proc/zombies()
	...
	for(var/turf/T in wormholeturfs)
		if(prob(3))
			new/obj/item/woodstuff/plank(T)
			new/obj/item/woodstuff/plank(T)
