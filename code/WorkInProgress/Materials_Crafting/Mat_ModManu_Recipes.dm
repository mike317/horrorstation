...
/datum/modular_recipe/ghettoweapon
	recipe_name = "Ghetto weapon"
	recipe_desc = "Allows you to improvise various weapons using everyday materials."
	manual_component_handling = 1

	New(var/obj/workbench/w)

		recipe_parts.Add(new/datum/modular_component/item_any/ghettobase(src))
		recipe_parts.Add(new/datum/modular_component/item_any/ghettoaddition1(src))
		recipe_parts.Add(new/datum/modular_component/item_any/ghettoaddition2(src))

		return ..(w)

	create()//ghetto crafting if this is a nonzero value. If this is a string,
	//it's the identity of what we're making
		var/datum/modular_component/ghettobase = recipe_parts[1]
		var/datum/modular_component/ghettoaddition1 = recipe_parts[2]
		var/datum/modular_component/ghettoaddition2 = recipe_parts[3]

		var/obj/item/ghettobaseobj = ghettobase.slot_object
		...
		if (ghettobaseobjs.Find(ghettobaseobj.type) && ghettoadditionobjs.Find(ghettoadditionobj1.type))
			if (istype(ghettobaseobj, /obj/item/wirecutters))
				if (istype(ghettoadditionobj1, /obj/item/electronics/batteryassembly))
					...
					return electrocutters
			else if (istype(ghettobaseobj, /obj/item/wrench))
				if (istype(ghettoadditionobj1, /obj/item/electronics/batteryassembly))
					var/electrowrench = new/obj/item/craftedmelee/ghettotool/wrench/electrowrench(bench.loc)
					return electrowrench
			else if (istype(ghettobaseobj, /obj/item/crowbar))
				if (istype(ghettoadditionobj1, /obj/item/electronics/batteryassembly))
					var/electrobar = new/obj/item/craftedmelee/ghettotool/crowbar/electrobar(bench.loc)
					return electrobar
				else if (istype(ghettoadditionobj1, /obj/item/raw_material/shard/glass) && istype(ghettoadditionobj2, /obj/item/cable_coil))
		...
		return ghettobaseobj


/*
		if (materialobj)
			if (materialobj.ghetto_refine_stage == materialobj.end_at_stage)
				if (ghetto == "ghetto laser")
					var/obj/item/craftedmelee/ghettolaser/knife = new/obj/item/craftedmelee/knife(bench.loc)
				else if (ghetto == "ghetto handgun")
					var/obj/item/craftedmelee/ghettogun/knife = new/obj/item/craftedmelee/knife(bench.loc)
				else if (ghetto == "ghetto handgun two")
					var/obj/item/craftedmelee/ghettogun2/knife = new/obj/item/craftedmelee/knife(bench.loc)
				else if (ghetto == "bullet")
					var/obj/item/craftedmelee/ghettobullet/knife = new/obj/item/craftedmelee/knife(bench.loc)
				else if (ghetto == "baton")
					var/obj/item/craftedmelee/ghettobaton/knife = new/obj/item/craftedmelee/knife(bench.loc)
				else if (ghetto == "armor")
					var/obj/item/craftedmelee/ghettoarmor/knife = new/obj/item/craftedmelee/knife(bench.loc)
				else if (ghetto == "helmet")
					var/obj/item/craftedmelee/ghettohelmet/knife = new/obj/item/craftedmelee/knife(bench.loc)
				else if (ghetto == "knife")
					var/obj/item/craftedmelee/ghettoknife/knife = new/obj/item/craftedmelee/knife(bench.loc)
				else if (ghetto == "rollingpin")
					var/obj/item/craftedmelee/ghettorollingpin/rollingpin = new/obj/item/craftedmelee/rollingpin(bench.loc)
*/
...
/datum/modular_component/item_any/ghettobase
	component_name = "any item (base)"

/datum/modular_component/item_any/ghettoaddition1
	component_name = "any item (addition 1)"

/datum/modular_component/item_any/ghettoaddition2
	component_name = "any item (addition 2)"
